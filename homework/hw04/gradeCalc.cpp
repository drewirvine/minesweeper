...
int main() {
    ...
    // gather input
    cout << "Enter your test, homework, and participation averages separated by spaces: ";
    cin >> TEST_AVERAGE >> HOMEWORK_AVERAGE >> PART_AVERAGE;

    // validate that input

    if((TEST_AVERAGE > 100) || (HOMEWORK_AVERAGE > 100) || (PART_AVERAGE > 100)) {
    ...
    if((FINAL_GRADE < 100) && (FINAL_GRADE >= 90)) { 
        cout << "You have an A in the class and do not need to take the final." << endl;
    }
